...
// Display font: Serif style for headings (replace with custom font when available)
// To use custom fonts, add font files to res/font/ and uncomment:
...
// Body font: Sans-serif for body text (replace with custom font when available)
